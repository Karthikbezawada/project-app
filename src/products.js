...
//         <div>
//             <Navbar />
//             <h1 className='text-center text-success '>Jai Hanuman</h1>
//             <div className='container'>
//                 <div className='row'>
//                     <div className='col-md-3 mr-1'>
//                         <div className="card" style={{ width: '18rem' }}>
//                             <img src="https://images.pexels.com/photos/788946/pexels-photo-788946.jpeg?auto=compress&cs=tinysrgb&w=800" className="card-img-top" alt="..." />
